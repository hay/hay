...
## The Design of HTML5 / [Jeremy Keith](http://www.adactio.com) [@adactio](http://www.twitter.com/adactio)
* "Design principles"
    * As in vision, see e.g Karl Marx en Declaration of Independence
...
## Vector Graphics for the Web - [Brad Neuberg](http://codinginparadise.org/) - [@bradneuberg](http://twitter.com/bradneuberg) [Ajaxian](http://ajaxian.com)
* "Small pieces loosely joined"
* [Ultracool presentation from Brad](http://brad.com/html5-3d-slides/html5.html)
* Google indexes SVG
...
* "Nobody is ever going to use rounded corners" - Lie about CSS in 1994
* `box-shadow: inset;`
...
## Progressive Downloads and Rendering - [Stoyan Stefanov](http://www.phpied.com) [@stoyanstefanov)(http://twitter.com/stoyanstefanov) (Yahoo)
...
## Reusable code, for good or awesome - [Jake Archibald](http://www.jakearchibald.com/) [@jaffathecake](http://twitter.com/jaffathecake)
* Used to work at the BBC (Glow JS library), now working at theTeam
